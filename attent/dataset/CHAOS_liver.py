...
class CHAOS_DataSet(BaseDataset):
    def __init__(self, root, list_path, set='all',
        ...
        for name in self.img_ids:
            ...
            # self.files.append((img_file, label_file,label_file_liver,label_file_rightK,label_file_leftK,label_file_spleen, name))
            # self.files.append((img_file, label_file,label_file_AA,label_file_LAC,label_file_LVC,label_file_MYO, name))
    ...
    def get_metadata(self, name):
        img_file = self.root/ 'train' /'A_image'/ name#/ 'train'/'translated_image' / name
        label_file = self.root/'train' /'A_label'/ name#/ 'train'/'liver_label / name
        label_file_liver = self.root/'train' /'A_label'/'liver_label'/ name#/ 'train'/'liver_label / name
        label_file_rightK = self.root/'train' /'A_label'/'rightKidney_label'/ name#/ 'train'/'liver_label / name
        label_file_leftK = self.root/'train' /'A_label'/'leftKidney_label'/ name#/ 'train'/'liver_label / name
        label_file_spleen = self.root/'train' /'A_label'/'spleen_label'/ name#/ 'train'/'liver_label / name
