...
from domain_adaptation.train_UDA_tmp import train_domain_adaptation
...
def main():
    ...
    print('len(source_dataset):',len(source_dataset))
    ...
    # valid_dataset = CHAOS_validSet(root=cfg.DATA_DIRECTORY_TARGET,
    #                                     list_path=cfg.DATA_LIST_TARGET,
    #                                     set=cfg.TRAIN.SET_VALID,
    #                                     # info_path=cfg.TRAIN.INFO_TARGET,
    #                                     max_iters=cfg.TRAIN.MAX_ITERS,# * cfg.TRAIN.BATCH_SIZE_TARGET,
    #                                     crop_size=cfg.TRAIN.INPUT_SIZE_TARGET,
    #                                     mean=cfg.TRAIN.IMG_MEAN)
