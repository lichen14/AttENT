...
from advent.dataset.dataset_2d import source_train_fix_ds,source_valid_fix_ds,target_train_fix_ds,target_valid_fix_ds
from advent.domain_adaptation.config import cfg, cfg_from_file
from advent.domain_adaptation.train_UDA_tmp import train_domain_adaptation
...
def main():
    ...
    source_loader = data.DataLoader(source_train_fix_ds,
    ...
    target_dataset = CityscapesDataSet(root=cfg.DATA_DIRECTORY_TARGET,
                                       ...
                                       mean=cfg.TRAIN.IMG_MEAN)
    target_loader = data.DataLoader(target_train_fix_ds,
