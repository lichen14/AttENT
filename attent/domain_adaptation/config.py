...
cfg.DATA_LIST_SOURCE = './attent/dataset/CHAOS_list/source.txt'
cfg.DATA_LIST_TARGET = './attent/dataset/MALBCV_list/target.txt'
cfg.DATA_LIST_VALID = './attent/dataset/MALBCV_list/test.txt'
# cfg.DATA_LIST_SOURCE = cfg.DATA_LIST_TARGET
# Directories
cfg.DATA_DIRECTORY_SOURCE = './attent/datasets/<MALBCV or CHAOS>/'
cfg.DATA_DIRECTORY_TARGET = './attent/datasets/<MALBCV or CHAOS>/'
# cfg.DATA_DIRECTORY_SOURCE = cfg.DATA_DIRECTORY_TARGET
# Number of object classes
cfg.NUM_CLASSES = 5#19      #?2
# Exp dirs
cfg.EXP_NAME = ''
...
cfg.TRAIN = EasyDict()
cfg.TRAIN.EPOCHS = 40
cfg.TRAIN.SET_SOURCE = 'source'
cfg.TRAIN.SET_VALID = 'val'
cfg.TRAIN.SET_TARGET = 'target'
cfg.TRAIN.BATCH_SIZE_SOURCE = 12
cfg.TRAIN.BATCH_SIZE_TARGET = 12
cfg.TRAIN.IGNORE_LABEL = 255
cfg.TRAIN.INPUT_SIZE_SOURCE = (256,256)#(1280, 720)
cfg.TRAIN.INPUT_SIZE_TARGET = (256,256)#(1024, 512)
# Class info
cfg.TRAIN.INFO_SOURCE = ''
cfg.TRAIN.INFO_TARGET = str(project_root / 'attent/dataset/cityscapes_list/info.json')
...
cfg.TRAIN.LEARNING_RATE = 1e-5#2.5e-4#1e-6#
...
cfg.TEST.SNAPSHOT_MAXITER = 100000  # used in 'best' mode
# Test sets
cfg.TEST.SET_TARGET = 'test'
cfg.TEST.BATCH_SIZE_TARGET = 1
cfg.TEST.INPUT_SIZE_TARGET = (256,256)#(1024, 512)
cfg.TEST.OUTPUT_SIZE_TARGET = (256,256)#(2048, 1024)
cfg.TEST.INFO_TARGET = str(project_root / 'attent/dataset/cityscapes_list/info.json')
